...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $hargaproduk = $_POST["productprice"];
    

    $arahanSQL = mysqli_prepare($conn, "INSERT INTO ecommerce_db.products (product_name,price) VALUES (?,?)");
    mysqli_stmt_bind_param($arahanSQL, "ss", $namaproduk, $hargaproduk);
    if (mysqli_stmt_execute($arahanSQL)) {
        $mesej = "<p style='color:green;'>Berjaya masuk data</p>";
    } else {
        $mesej = "<p style='color:red;'>Gagal... Tidak Berjaya masuk data</p>";
    }
